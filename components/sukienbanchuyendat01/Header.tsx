...
export default function Header() {
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 bg-brand-teal">
        <nav className="flex items-center justify-between py-6">
          ...
          <div className="hidden lg:flex items-center gap-8 xl:gap-12">
            ...
            <button className="flex items-center gap-1 text-[#656C86] text-[15px] font-semibold hover:text-[#00ACB8] transition-colors">
              Giáo dục tài chính
